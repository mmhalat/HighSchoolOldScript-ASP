...
sql = " Select * from personel where pkid=" & id
ISresim.open sql,baglanti,1,3%>
<br>
<table width="458" border="0" cellpadding="1" cellspacing="1" bordercolor="#8EA9C3" bgcolor="#8EA9C3">
      <tbody><tr>
        <td height="8" colspan="2" bgcolor="#A02416"><div align="center"><span class="style2">Personel Resimleri</span></div></td>
        </tr>
			<%
...
%>
        <tr>
          <td width="100" height="30" rowspan="3" bgcolor="#DFE5E7"><a href="personeldetay.asp?id=<%=ISresim("id")%>" target="uye" onClick="window.open('galeri_detay.asp?id=<%=ISresim("id")%>','uye','width=800 height=600 toolbar=yes scrollbaISresim=yes' )"><img src="<%=ISresim("presim")%>" border=0 width="100" height="100"></a></td>
          <td width="350" height="30" bgcolor="#D1DCE9">Personel İsmi :<%=ISresim("personeladi")%> </td>
        </tr>
        <tr>
          <td height="30" bgcolor="#D1DCE9">Aciklama :<%=ISresim("personelbilgi")%> </td>
        </tr>
        <tr>
...
response.write "<b> <a href=""personeloku.asp?id="&id&"&git="&y&""">"&y&"</a></b>"
end if
next
