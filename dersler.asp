...
<!--#include file="isinc/sol.asp"-->
      ...
      <tbody><tr>
        <td width="458" height="8" bgcolor="#A02416"><span class="style2">DERS KATEGORİLERİ </span></td>
        </tr>
        <tr>
          <td height="9" bgcolor="#DFE5E7"><img src="istikbal_resimler/orta_data/default_data/devami.gif" width="8" height="10" />&nbsp;Matematik<br>
          <img src="istikbal_resimler/orta_data/default_data/devami.gif" width="8" height="10" />&nbsp;Geometri<br>
          <img src="istikbal_resimler/orta_data/default_data/devami.gif" width="8" height="10" />&nbsp;Kimya<br>
          <img src="istikbal_resimler/orta_data/default_data/devami.gif" width="8" height="10" />&nbsp;Fizik<br>
          <img src="istikbal_resimler/orta_data/default_data/devami.gif" width="8" height="10" />&nbsp;Edebiyat<br>
          <img src="istikbal_resimler/orta_data/default_data/devami.gif" width="8" height="10" />&nbsp;Dil Ve Anlatım<br>
          <img src="istikbal_resimler/orta_data/default_data/devami.gif" width="8" height="10" />&nbsp;Resim</td>
        </tr>		
    </table></td>
