...
<!--#include file="isinc/sol.asp"-->
      ...
      <tbody><tr>
        <td width="458" height="8" bgcolor="#A02416"><span class="style2">Yapılan Tüm Duyurular </span></td>
        </tr>
		<%
...
%>
        <tr>
          <td height="19" bgcolor="#DFE5E7"><img src="istikbal_resimler/orta_data/default_data/devami.gif" width="8" height="10" />&nbsp;<%=IShaber("baslik")%></td>
        </tr>			 <center> <%IShaber.movenext
		next %>
		        Sayfa :          
          <%
for y=1 to sayfa 
...
response.write "<b> <a href=""haberler.asp?id="&id&"&git="&y&""">"&y&"</a></b>"
end if
next
%><%IShaber.close%></center>
    </table></td>
