...
<!--#include file="isinc/sol.asp"-->
      ...
      <tbody><tr>
        ...
        <tr>
          <td height="207" bgcolor="#DFE5E7"><p>Düşünme, algılama, problem çözme yeteneği gelişmiş, </p>
            <p> Bilgiyi yaratıcı bir şekilde kullanabilien, </p>
            <p> Bilgi çağı kimliğine uygun araştırmacı, bilim ve teknoloji üretimine yatkın, kendinini tanıtmaktan ve açıklamaktan korkmayan, hızlı ve sağlıklı kararlar alabilme becerisi gelişmiş, </p>
            <p> İçinde yaşadığı toplumun tarihini ve kültürnü tanıyan, Atatürk ilke ve inkilaplarına bağlı bireyler yetiştirmektir. </p></td>
          <td height="207" bgcolor="#DFE5E7"><p>Öğrenci merkezli ve öğretmen-öğrenci etkileşimine önem veren, </p>
            <p>Ezberden uzak eğitim anlayışı içinde, </p>
            <p>Okul-aile-öğrenci işbiriliğine dayalı, </p>
            <p>Bilgi düzeyindeki bilgilerden ziyade kavramaya, analiz ve senteze ağırlık veren, </p>
            <p>"Öğrenmeyi öğrenme" yi sağlayacak, </p>
            <p>Bilimsel sosyal ve kültürel gelişmeleri takip eden bir ortaöğretim kurumu olmaktır. </p></td>
        </tr>
    </table></td>
