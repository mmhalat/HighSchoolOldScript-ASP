...
sql = " Select * from dokuman where id=" & id
ISdokuman.open sql,baglanti,1,3%>
<br>
<table cellpadding="0" cellspacing="0">
<tr bgcolor="#A02416">
<td height="18" colspan="3"><span class="style2"><%=ISdokuman("adi")%>&nbsp;</span></td>
</tr>
<tr>
  <td width="148" height="20">Döküman Adı</td>
  <td width="4" height="20">:</td>
  <td width="304" height="20"><%=ISdokuman("adi")%></td>
  </tr>
<tr>
  <td height="20">Döküman Aciklamasi </td>
  <td width="4" height="20">:</td>
  <td height="20"><%=ISdokuman("aciklama")%></td>
  </tr>
<tr>
  <td height="20">Ekleyen</td>
  <td width="4" height="20">:</td>
  <td height="20"><%=ISdokuman("ekleyen")%></td>
  </tr>
<tr>
...
<tr>
  <td height="37" colspan="3"><center><a href="dokindir.asp?id=<%=ISdokuman("id")%>"><img src="istikbal_resimler/indir.gif" width="130" height="60" border="0" /></a></center></td>
  </tr>
</table>
