...
<!--#include file="isinc/sol.asp"-->
      ...
      <tbody><tr>
        <td width="229" height="8" bgcolor="#A02416"><div align="center"><span class="style2">Vizyonumuz</span></div></td>
        <td width="229" bgcolor="#A02416"><div align="center"><span class="style2">Misyonumuz</span></div></td>
      </tr>
	
        <tr>
          <td height="207" bgcolor="#DFE5E7">&nbsp;</td>
          <td height="207" bgcolor="#DFE5E7">&nbsp;</td>
        </tr>
    </table></td>
