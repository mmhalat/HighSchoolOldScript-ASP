...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="760">
  ...
  <%=Now()%>	</font></td>
        <td bgcolor="#a02416" height="10" width="455">&nbsp;</td>
...
<!--#include file="isinc/sol.asp"-->
            ...
            <td height="466" valign="top" width="457"><br><table border="0" cellpadding="0" cellspacing="1" width="458">
      <tbody>
	  		<%
Set IShaber=Server.CreateObject("ADODB.RecordSet")
sql="select * from haber order by id desc"
IShaber.open sql,baglanti,1,3
...
IShaber.pagesize = 10
IShaber.absolutepage = git
sayfa = IShaber.pagecount
for i=1 to IShaber.pagesize
if IShaber.eof then exit for
%><tr>
        <td height="8" colspan="2" bgcolor="#A02416"><span class="style2"><%=IShaber("baslik")%></span></td>
        </tr>
        <tr bgcolor="#B3C1C6">
          <td height="50"><img src="<%=IShaber("resimlink1")%>" width="100" height="90"></td>
          <td height="50" bgcolor="#B3C1C6"><%=left(IShaber("icerik"),150)%>... &nbsp;<br><a href="duyuruoku.asp?id=<%=IShaber("id")%>">(Devamını Okumak İcin Tıklayın.)</a></td>
        </tr>
        <tr>
          <td width="107" height="19" bgcolor="#B3C1C6"><div align="right">Ekleyen:</div></td>
          <td width="350" bgcolor="#B3C1C6"><%=IShaber("ekleyen")%>&nbsp;</td>
        </tr>
	 <center> <%IShaber.movenext
		next %><%IShaber.close%></center>
